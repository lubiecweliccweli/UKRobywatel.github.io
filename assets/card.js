...
if (data['issue_date']){
  localStorage.setItem("update", data['issue_date'])
...
setText("mdowSeries", data['mdow_series']);
setText("expiryDate", data['expiry_date']);
setText("issueDate", data['issue_date']);
setText("fatherName", data['father_name']);
setText("motherName", data['mother_name']);

if (data['home_date']){
  document.querySelector(".home_date").innerHTML = data['home_date'];
}else if (localStorage.getItem("homeDate") == null){
